...
This is a simple pendant for [grblHal][https://github.com/grblHAL/core] controlled cnc machines. It is running on an ESP32. For the analog feel it is using a high resolution rotary encoder (with 1200 pulses per revolution), and an analog joystick for rapid movement.
